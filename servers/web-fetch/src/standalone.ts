...
import type { WebFetchOptions, WebFetchResult, WebFetcherEnv } from './types.ts';
import { WebFetcher } from './services/web-fetcher.ts';
...
export { WebFetcher } from './services/web-fetcher.ts';
export { HTMLProcessor } from './utils/html-processor.ts';
export type { WebFetchOptions, WebFetchResult, WebFetcherEnv } from './types.ts';